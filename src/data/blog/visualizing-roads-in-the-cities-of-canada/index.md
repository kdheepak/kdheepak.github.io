...
[Statistics Canada](https://www12.statcan.gc.ca/census-recensement/2011/geo/RNF-FRR/index-eng.cfm).
...
:::div{.cell-output .cell-output-display} 35.535843 seconds (169.74 M
allocations: 8.115 GiB, 23.57% gc time, 1.44% compilation time) size(gdf) =
(2242117, 26) :::

:::div{.cell-output .cell-output-display} | | geometry | | | --- | --- | --- | |
1 | Polyline(Rect(7.65014e6, 1.27149e6, 7.65038e6, 1.2717e6), Int32[0],
Point[Point(7.65014e6, 1.27149e6), Point(7.65017e6, 1.2715e6), Point(7.6502e6,
1.27152e6), Point(7.65023e6, 1.27153e6), Point(7.65024e6, 1.27154e6),
Point(7.65027e6, 1.27156e6), Point(7.6503e6, 1.27158e6), Point(7.65031e6,
1.27159e6), Point(7.65033e6, 1.27162e6), Point(7.65035e6, 1.27164e6),
Point(7.65036e6, 1.27166e6), Point(7.65037e6, 1.27169e6), Point(7.65038e6,
1.2717e6)]) | $\dots$ | ::: :::::

The documentation says `CSDNAME` is the "Census subdivision name", which seems
to map to cities.
...
:::div{.cell-output .cell-output-display} 17.307230 seconds (107.98 M
allocations: 9.264 GiB, 31.09% gc time, 1.18% compilation time: 7% of which was
recompilation) ::: ::::
