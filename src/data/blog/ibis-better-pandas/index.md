...
There's an excellent blog post on why
[Pandas feels clunky for those coming from R](https://www.sumsar.net/blog/pandas-feels-clunky-when-coming-from-r/).

However in Python, I've found `ibis` as an alternative to `pandas` to be a much
more natural fit for those coming from `R`.

[`ibis`](https://ibis-project.org/) uses duckdb as a backend by default, and its
API is a mix between duckdb and dplyr.
...
this is useful for chaining operations or for using the result of the last
expression in subsequent operations
...
immediately executed when displayed. This is useful for interactive exploration.
...
Here's the equivalent code in `pandas` and `ibis` for the example provided in
the blog post:
...
:::div{.cell-output .cell-output-display} | | country | amount | discount | |
--- | --- | --- | --- | | 0 | USA | 2000 | 10 | | 1 | USA | 3500 | 15 | | 2 |
USA | 3000 | 20 | | 3 | Canada | 120 | 12 | | 4 | Canada | 180 | 18 | ::: ::::
...
:::div{.cell-output .cell-output-display} | | country | total | | --- | --- |
--- | | 0 | Australia | 600 | | 1 | Brazil | 460 | | 2 | Canada | 3400 | | 3 |
France | 500 | | 4 | Germany | 570 | | 5 | India | 720 | | 6 | Italy | 630 | | 7
| Japan | 690 | | 8 | Spain | 660 | | 9 | UK | 480 | | 10 | USA | 8500 | :::
::::
...
Calling `.execute()` will run the query and return the result as a pandas
DataFrame.
...
:::div{.cell-output .cell-output-display} | | country | total | | --- | --- |
--- | | 0 | Australia | 540 | | 1 | Brazil | 414 | | 2 | Canada | 3349 | | 3 |
France | 450 | | 4 | Germany | 513 | | 5 | India | 648 | | 6 | Italy | 567 | | 7
| Japan | 621 | | 8 | Spain | 594 | | 9 | UK | 432 | | 10 | USA | 8455 | :::
::::
...
:::div{.cell-output .cell-output-display} | | country | total | | --- | --- |
--- | | 0 | Australia | 540 | | 1 | Brazil | 414 | | 2 | Canada | 270 | | 3 |
France | 450 | | 4 | Germany | 513 | | 5 | India | 648 | | 6 | Italy | 567 | | 7
| Japan | 621 | | 8 | Spain | 594 | | 9 | UK | 432 | | 10 | USA | 1990 | :::
::::
...
For this last example, we have to resort to calculating the median after a group
by operation over each country and then join it back to the original DataFrame
to replace the outliers. This is similar to the pandas approach.
