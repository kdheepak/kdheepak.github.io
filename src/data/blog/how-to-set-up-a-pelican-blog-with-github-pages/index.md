...
description:
  Here, I will show how to set up a working static blog on github pages using Pelican. Pelican is a
...
I've been quite vocal about the benefits of blogging using Markdown, and using a static page
generator with Pandoc instead of the conventional CMS. But a lot of people I've spoken to have
...
- Platform independent - You can edit your blog posts from anywhere, be it on your PC, tablet or
  mobile device. You can even use your favourite text editor. (which is obviously VIM, right?)
...
You can also type the following to serve a local version of your site to view the output of your
hardwork
...
You are done! If you have any questions regarding any of this, you can shoot me questions in the
comments below.
