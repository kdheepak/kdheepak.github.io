...
Using `InlineTests` together with `Revise`.
This combination allows you to write tests directly in your source files, and you can make changes that are tracked with Revise, allowing faster iteration with test driven development.
...
This allows co-locating the tests with the implementation of the code.
