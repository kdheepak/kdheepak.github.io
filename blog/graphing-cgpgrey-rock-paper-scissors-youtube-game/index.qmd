...
You can click to drag and use the mouse wheel to zoom in the above plot.
...
using Markdown
using Dates
display(md"Here's a table that contains the sorted view count as of $(Dates.today()):")
```
...
df = DataFrame(Title=String[], Views=Int[])
