---
title: Roads in the cities of Canada
categories: [julia, visualization]
keywords: julia
...
```{julia}
begin
  gdf[!, :CSDNAME_L_UTF8] = decode.(Vector{UInt8}.(String.(coalesce.(gdf[!, :CSDNAME_L], ""))), "Windows-1252")
  gdf[!, :CSDNAME_R_UTF8] = decode.(Vector{UInt8}.(String.(coalesce.(gdf[!, :CSDNAME_R], ""))), "Windows-1252")
end
nothing #| hide_line
```
